      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-1">
            <div className="mb-4">
              <a href="#" className="text-2xl font-bold gradient-text">Srijan.ai</a>
            </div>
            <p className="text-foreground/70 mb-4">
              Transforming ideas into digital reality. We build innovative web apps, mobile solutions, WhatsApp bots, and AI agents.
            </p>
            <button
              onClick={scrollToTop}
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-foreground/70 hover:text-primary transition-colors">Web Applications</a></li>
              <li><a href="#" className="text-foreground/70 hover:text-primary transition-colors">Mobile Apps</a></li>
              <li><a href="#" className="text-foreground/70 hover:text-primary transition-colors">WhatsApp Bots</a></li>
              <li><a href="#" className="text-foreground/70 hover:text-primary transition-colors">AI Agents</a></li>
              <li><a href="#" className="text-foreground/70 hover:text-primary transition-colors">Custom Solutions</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-foreground/70 hover:text-primary transition-colors">Portfolio</a></li>
        ...
        <div className="border-t border-muted mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-foreground/60 text-sm mb-4 md:mb-0">
            &copy; {new Date().getFullYear()} Srijan.ai Agency. All rights reserved.
          </p>
